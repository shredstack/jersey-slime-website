...
export default function FAQPage() {
  ...
  return (
    <>
      <head>
        <title>Frequently Asked Questions | Jersey Slime Studio 38</title>
        <meta
          name="description"
          content="Find answers to common questions about Jersey Slime Studio 38 — ages, what to wear, session length, group sizes, booking, and more."
        />
      </head>
